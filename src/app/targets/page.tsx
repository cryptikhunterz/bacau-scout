...
const CB_TARGETS_DATA: (TargetPlayer & { cbMetrics: CBMetrics })[] = [
  ...
  },
  {
    ...
    notes: "13 matches/1241 mins at Trapani. 2Y/0R — clean. 9.21 successful defensive actions/90. 0.94 shots blocked/90 is elite — physical shot blocker. 7.69 progressive passes/90 shows he can carry forward despite being a giant. Moldovan-born like Dumbravanu.",
    screenshots: [],
    hasVideo: false,
  ...
  },
  {
    ...
    notes: "On loan — appears in both Serie C and Liga II data (Voluntari). Need to clarify parent club. 1Y/1R in 11 matches — the red card is a concern. 6.80 progressive passes/90 but 78% pass accuracy — tries to play forward but accuracy suffers. Long pass accuracy 45.65%. Left foot is his main selling point for a back line that needs balance.",
    screenshots: [],
    hasVideo: false,
