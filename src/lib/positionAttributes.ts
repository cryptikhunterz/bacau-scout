...
export const POSITION_TEMPLATES: Record<PositionCategory, PositionTemplate> = {
  ...
  'Full-Back': {
    ...
    groups: [
      ...
      { title: 'Tactical', attributes: ['Positioning', 'Transition Play', 'Width', 'Pressing', 'Tactical Discipline'] },
  ...
  'Defensive Midfield': {
    ...
    badge: '🔒',
    groups: [
      { title: 'Defensive Actions', attributes: ['Tackling', 'Interceptions', 'Pressing', 'Aerial Duels', 'Shielding', 'Recovery'] },
  ...
  'Central Midfield': {
    ...
    badge: '⚙️',
    groups: [
      { title: 'Defensive Actions', attributes: ['Tackling', 'Interceptions', 'Pressing', 'Recovery Runs'] },
      ...
      { title: 'Tactical', attributes: ['Positioning', 'Transition', 'Movement', 'Pressing', 'Game Management'] },
  ...
  Winger: {
    ...
    badge: '⚡',
    groups: [
      { title: 'Defensive Actions', attributes: ['Pressing', 'Tracking Back', 'Recovery Runs'] },
      ...
      { title: 'Tactical', attributes: ['Width', 'Movement', 'Transition', 'Positioning', 'Pressing'] },
  ...
  'Centre-Forward': {
    ...
    badge: '⚽',
    groups: [
      { title: 'Defensive Actions', attributes: ['Pressing', 'Hold-up Play', 'Aerial Challenges'] },
      ...
      { title: 'Tactical', attributes: ['Movement', 'Positioning', 'Pressing', 'Space Creation', 'Runs'] },
